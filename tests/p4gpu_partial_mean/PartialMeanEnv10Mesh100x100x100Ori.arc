...
<case codeversion="1.0" codename="Pattern4GPU" xml:lang="en">
  <arcane>
    <title>Benchmark les calculs de valeurs partielles sur les mailles pures et mixtes puis maj grandeur moyenne</title>
    <timeloop>PartialAndMeanLoop</timeloop>
  </arcane>
  ...
  <pattern4-g-p-u>
    ...
    <partial-and-mean-version>ori</partial-and-mean-version>
    <!-- <partial-and-mean-version>ori_v2</partial-and-mean-version> -->
    <!-- <partial-and-mean-version>arcgpu_v1</partial-and-mean-version> -->
  </pattern4-g-p-u>
</case>
