...
<!--       <variable>Tensor</variable> -->
  ...
  <pattern4-g-p-u>
    ...
    <init-node-vector-version>kokkos</init-node-vector-version>
    <init-node-coord-bis-version>kokkos</init-node-coord-bis-version>
    <init-cell-arr12-version>kokkos</init-cell-arr12-version>
    <!-- <compute-cqs-vector-version>ori</compute-cqs-vector-version> -->
    <compute-cqs-vector-version>kokkos</compute-cqs-vector-version>
  </pattern4-g-p-u>
</case>
