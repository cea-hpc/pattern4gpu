...
<!--   </arcane-post-processing> -->
  ...
  <pattern4-g-p-u>
    ...
    <compute-cqs-vector-version>arcgpu_v2</compute-cqs-vector-version>

    <ccav-vector-sync-version>overlap_evqueue</ccav-vector-sync-version>
  </pattern4-g-p-u>
</case>
